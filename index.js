...
const { sha3, toChecksumAddress, padRight } = require('web3-utils')
...
function main() {
  ...
  for(let [jobName, jobId] of Object.entries(JOBS)) {
    console.log(`Creating watcher for ${jobName}. The JOBID is ${jobId}`)
    web3.eth.subscribe('logs', {
      // address: '',
      topics: ['0xd8d7ecc4800d25fa53ce0372f13a416d98907a7ef3d8d3bdd79cf4fe75529c65', padRight('0x' + jobId, 64)]
    }).on('data', (event) => {
